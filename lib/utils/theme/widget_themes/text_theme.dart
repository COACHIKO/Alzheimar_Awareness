...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodyLarge: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w500, color: TColors.dark),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodyLarge: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w500, color: TColors.light),
